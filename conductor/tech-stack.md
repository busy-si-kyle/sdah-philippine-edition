...
- **Animations:** `framer-motion` for smooth, staggered UI transitions.
...
- **Performance:** `react-virtuoso` for efficient rendering of the large hymn list on the landing page.
